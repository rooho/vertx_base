...
import cc.phonecard.jooq.tables.interfaces.ISqliteSequence;
...
public class SqliteSequenceRecord extends TableRecordImpl<SqliteSequenceRecord> implements VertxPojo, Record2<Object, Object>, ISqliteSequence {
     ...
     * Create a detached, initialised SqliteSequenceRecord
     */
    public SqliteSequenceRecord(cc.phonecard.jooq.tables.pojos.SqliteSequence value) {
        super(SqliteSequence.SQLITE_SEQUENCE);
        ...
        public SqliteSequenceRecord(io.vertx.core.json.JsonObject json) {
                this();
                fromJson(json);
        }
}
